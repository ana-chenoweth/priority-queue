...
public:
    ...
    void Eliminar();
    /** \brief M&eacute;todo que regresa el tama�o (el n&uacute;mero de individuos) de la ColaMedieval
     *
     * \return int Tamano de la ColaMedieval.
     *
     */
    int ObtenerTam() const;
    /** \brief M&eacute;todo que regresa el tama�o (el n&uacute;mero de individuos de la clase social Plebeyo) de la ColaMedieval
     *
     * \return int Tamano de los individuos Plebeyos de la ColaMedieval.
     *
     */
    int ObtenerTamPlebeyo() const;
    /** \brief M&eacute;todo que regresa el tama�o (el n&uacute;mero de individuos de la clase social Noble) de la ColaMedieval
     *
